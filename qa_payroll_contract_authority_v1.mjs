...
t('payroll close is blocked while any contract or attendance issue remains',()=>{assert(mod.includes("r.contractMode!=='CONTRACT'||Number(r.issues||0)>0"));assert(mod.includes('close.disabled=true'));assert(mod.includes('급여 마감 보류'))});
