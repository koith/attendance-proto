...
t('payroll close is blocked while any contract or attendance issue remains',()=>{assert(mod.includes("r.contractMode!=='CONTRACT'||Number(r.issues||0)>0"));assert(mod.includes('close.disabled=!!blockers.length'));assert(mod.includes('확인필요 항목을 먼저 해결하세요.'))});
