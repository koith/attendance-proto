...
t('main employee names carry stable No. based on employee id',()=>{assert(main.includes('padStart(2'));assert(main.includes('att-name'));assert(main.includes("#adEmps .row"));assert(main.includes("#empGrid .emp .nm"))});
...
t('contract flow shows employee No. and loads identity layer',()=>{assert(contract.includes('employee-no-sub'));assert(contract.includes('employeeId'));assert(contractHtml.includes('employment_contract_employee_number_v1.js?v=20260914b'))});
