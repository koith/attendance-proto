...
t('mobile runtime is cache-busted and wired',()=>{a(html.includes('actual_attendance.css?v=20260913f'),'css cache-bust missing');a(html.includes('actual_attendance.js?v=20260913f'),'js cache-bust missing');a(html.includes('supabase_session_resilience_v1.js?v=20260913f'),'session layer missing');a(html.includes('actual_attendance_entry_mode_v1.js?v=20260913f'),'entry mode missing');a(css.includes('.calendar'),'calendar style missing');a(css.includes('.track'),'timeline style missing')});
